...
const MedicalRecords = () => {
    ...
    setVisitSessions([
      {
        ...
        clothGiven: 1,
        shoesGiven: 16,
        educationProvided: "Counseling on drug abuse, STI education",
        foodGiven: 28,
        testsTotal: 37,
        medicationsGiven: {
          Albendazole: 16,
      ...
      },
      {
        ...
        clothGiven: 0,
        shoesGiven: 37,
        educationProvided: "Corona education, Counseling on drug abuse",
        foodGiven: 24,
        testsTotal: 37,
      },
      {
      ...
      },
      {
        ...
        clothGiven: 0,
        shoesGiven: 29,
        educationProvided: "STI education",
        foodGiven: 13,
        testsTotal: 8,
      },
      {
      ...
      },
      {
        ...
        clothGiven: 0,
        shoesGiven: 34,
        educationProvided: "Counseling on drug abuse",
        foodGiven: 43,
        testsTotal: 49,
      },
      {
  ...
  const saveVitals = async () => {
    ...
    try {
      ...
      const history = await api.getVitalsHistory(child.id);
      setNutritionalHistory(history);
      setVitalsData({
        weight: "",
        height: "",
        bmi: "",
  ...
  const saveTestResult = async () => {
    try {
      ...
      const history = await api.getTestsHistory(child.id);
      setTestsHistory(history);
      setTestsData({
        testType: "",
        result: "",
        date: new Date().toISOString().split("T")[0],
  ...
  const saveEducation = async () => {
    try {
      await api.saveEducationServices(child.id, {
      ...
      const history = await api.getEducationHistory(child.id);
  ...
  const saveSymptoms = async () => {
    try {
      await api.saveSymptoms(child.id, {
        ...symptomsData,
        recordedBy: user?.id,
        recordedByName: getUserDisplayName(),
      });
    ...
    <Layout user={user} onLogout={handleLogout}>
      <div className="medical-records-page">
        ...
        <div className="mr-tabs-nav">
          <button
            className={`mr-tab-nav-btn ${activeTab === "baseline" ? "active" : ""}`}
            onClick={() => setActiveTab("baseline")}
          >
            Baseline Info
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "vitals" ? "active" : ""}`}
            onClick={() => setActiveTab("vitals")}
          >
            Vitals
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "nutritional" ? "active" : ""}`}
            onClick={() => setActiveTab("nutritional")}
          >
            Nutritional Status
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "medications" ? "active" : ""}`}
            onClick={() => setActiveTab("medications")}
          >
            Medications
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "tests" ? "active" : ""}`}
            onClick={() => setActiveTab("tests")}
          >
            Add Test Result
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "tests-history" ? "active" : ""}`}
            onClick={() => setActiveTab("tests-history")}
          >
            Tests History
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "medical-services" ? "active" : ""}`}
            onClick={() => setActiveTab("medical-services")}
          >
            Medical Services
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "social-services" ? "active" : ""}`}
            onClick={() => setActiveTab("social-services")}
          >
            Social Services
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "education" ? "active" : ""}`}
            onClick={() => setActiveTab("education")}
          >
            Education
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "education-history" ? "active" : ""}`}
            onClick={() => setActiveTab("education-history")}
          >
            Education History
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "symptoms" ? "active" : ""}`}
            onClick={() => setActiveTab("symptoms")}
          >
            Symptoms
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "clothing" ? "active" : ""}`}
          ...
          {/* NEW TABS */}
          <button
            className={`mr-tab-nav-btn ${activeTab === "visit-history" ? "active" : ""}`}
            onClick={() => setActiveTab("visit-history")}
          >
            Visit History
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "program-summary" ? "active" : ""}`}
            onClick={() => setActiveTab("program-summary")}
          >
            Program Summary
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "service-delivery" ? "active" : ""}`}
            onClick={() => setActiveTab("service-delivery")}
          >
            Service Delivery
          </button>
          <button
            className={`mr-tab-nav-btn ${activeTab === "history" ? "active" : ""}`}
                    ...
                    <tbody>
                      {nutritionalHistory.map((record, index) => (
                        <tr key={record.id || index}>
                          ...
                          <td>
                            <span
                              className={`mr-status-badge mr-status-${record.bmiStatus?.toLowerCase().replace(/\s/g, "-") || "unknown"}`}
                            >
            ...
            <div className="mr-form-card">
              ...
              <div className="mr-form-row">
                <div className="mr-form-group">
                  ...
                  <input
                    type="text"
                    value={medicationData.ntdsMeds}
                    onChange={(e) =>
                      setMedicationData({
                        ...medicationData,
                        ntdsMeds: e.target.value,
                      })
                    }
                    placeholder="e.g., Albendazole, Mebendazole"
                  />
                </div>
                <div className="mr-form-group">
                  ...
                  <input
                    type="text"
                    value={medicationData.antibiotics}
                    onChange={(e) =>
                      setMedicationData({
                        ...medicationData,
              ...
              <div className="mr-form-row">
                <div className="mr-form-group">
                  ...
                  <input
                    type="text"
                    value={medicationData.otherMeds}
                    onChange={(e) =>
                      setMedicationData({
                        ...medicationData,
                        otherMeds: e.target.value,
                      })
                    }
                ...
                <div className="mr-form-group">
                  ...
                  <input
                    type="date"
                    value={medicationData.dateGiven}
                    onChange={(e) =>
                      setMedicationData({
                        ...medicationData,
            ...
            <div className="mr-form-card">
              ...
              <div className="mr-form-row">
                <div className="mr-form-group">
                  ...
                  <select
                    value={testsData.testType}
                    onChange={(e) =>
                      setTestsData({ ...testsData, testType: e.target.value })
                    }
                  >
                ...
                <div className="mr-form-group">
                  <label>Result</label>
                  <select
                    value={testsData.result}
                    onChange={(e) =>
                      setTestsData({ ...testsData, result: e.target.value })
                    }
                  >
              ...
              <div className="mr-form-row">
                <div className="mr-form-group">
                  ...
                  <input
                    type="date"
                    value={testsData.date}
                    onChange={(e) =>
                      setTestsData({ ...testsData, date: e.target.value })
                    }
                  />
                </div>
              </div>
                    ...
                    <tbody>
                      {testsHistory.map((record, index) => (
                        <tr key={record.id || index}>
                          ...
                          <td>
                            <span
                              className={`mr-result-badge ${record.result?.toLowerCase().includes("positive") || record.result?.toLowerCase().includes("abnormal") ? "mr-result-positive" : "mr-result-negative"}`}
                            >
                              {record.result}
                            </span>
                          </td>
              ...
              <div className="mr-checkbox-grid">
                {medicalServicesOptions.map((service) => (
                  <label key={service} className="mr-checkbox-label">
                    <input
                      type="checkbox"
                      checked={medicalServicesData.servicesProvided.includes(
                        service,
                      )}
              ...
              <div className="mr-checkbox-grid">
                {socialServicesOptions.map((service) => (
                  <label key={service} className="mr-checkbox-label">
                    <input
                      type="checkbox"
                      checked={socialServicesData.servicesProvided.includes(
                        service,
                      )}
                  ...
                  {educationHistory.map((record, index) => (
                    <div key={record.id || index} className="mr-history-item">
                      <div className="mr-history-header">
                        ...
                        <span className="mr-history-badge">
                          Education Session
                        </span>
                      </div>
                      ...
                      <div className="mr-history-footer">
                        <span className="mr-history-by">
                          Provided by: {record.recordedByName || "Staff"}
                        </span>
                      </div>
                    </div>
                  ))}
            ...
            <div className="mr-form-card">
              ...
              <div className="mr-form-row">
                <div className="mr-form-group">
                  ...
                  <textarea
                    ...
                    rows="4"
                    placeholder="Describe symptoms (e.g., Fever for 3 days, cough, abdominal pain)"
                  />
                </div>
              </div>
              <div className="mr-form-row">
              ...
              <div className="mr-form-row">
                <div className="mr-form-group">
                  ...
                  <input
                    type="date"
                    value={symptomsData.date}
                    onChange={(e) =>
                      setSymptomsData({ ...symptomsData, date: e.target.value })
                    }
                  />
                </div>
              </div>
            ...
            <div className="mr-form-card">
              ...
              <div className="mr-form-row">
                <div className="mr-form-group">
                  ...
                  <input
                    type="date"
                    value={clothingData.date}
                    onChange={(e) =>
                      setClothingData({ ...clothingData, date: e.target.value })
                    }
                  />
                </div>
              </div>
        ...
        {activeTab === "visit-history" && (
          <div className="mr-tab-content">
            <div className="mr-history-card">
              ...
              <p className="mr-section-subtitle">
                Program-wide visit data from all outreach sessions
              </p>
                    ...
                    <tbody>
                      {visitSessions.map((session, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            {session.avgBMI > 0
                              ? session.avgBMI.toFixed(2)
                              : "N/A"}
                          </td>
                          <td>{session.clothGiven || 0}</td>
                          <td>{session.shoesGiven || 0}</td>
                          <td
                            className="mr-truncate-cell"
                            title={session.educationProvided}
                          >
              ...
              <div className="mr-dashboard-card">
                ...
                <div className="mr-metric-list">
                  <div className="mr-metric-item">
                    <span className="mr-metric-label">
                      Total Visits Recorded
                    </span>
                    <span className="mr-metric-value">
                      {programSummary.totalVisitsRecorded}
                    </span>
                  </div>
                  <div className="mr-metric-item">
                    <span className="mr-metric-label">
                      ...
                      <div key={status} className="mr-bmi-bar-item">
                        ...
                        <div className="mr-bmi-bar-container">
                          <div
                            ...
                            style={{
                              width: `${(count / Object.values(programSummary.bmiDistribution).reduce((a, b) => a + b, 0)) * 100}%`,
                            }}
                          ></div>
