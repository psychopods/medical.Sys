        ...
        <div className="footer-grid">
          <div className="footer-section">
            ...
            <div className="footer-social">
              ...
              <a href="https://twitter.com/tanzaniaruralhealth" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                <svg className="social-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.instagram.com/tanzaniaruralhealth" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <svg className="social-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.linkedin.com/company/tanzaniaruralhealth" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg className="social-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.youtube.com/channel/UCK_Is20EhKbGpXZ6Zg9Q0NA" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                <svg className="social-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="footer-section">
            <h4>Our Services</h4>
            <ul>
              <li><a href="/services">Medical Care</a></li>
              <li><a href="/services">Food Supply</a></li>
              <li><a href="/services">Clothing & Shoes</a></li>
              <li><a href="/services">Health Education</a></li>
              <li><a href="/services">Emotional Support</a></li>
              <li><a href="/services">Admission Support</a></li>
            </ul>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul className="contact-info">
              ...
              <li>
                ...
                +255 7688 668 490 / +255 759 095 943
              </li>
              <li>
                <svg className="contact-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
