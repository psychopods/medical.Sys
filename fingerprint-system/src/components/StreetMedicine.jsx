...
const StreetMedicine = () => {
  ...
  const fetchLocations = async () => {
    ...
    try {
      ...
      setLocations([]);
      showToast('Unable to load outreach locations. Please try again later.', 'error');
    } finally {
      setLoading(false);
    }
  };
              ...
              {locations.map((location) => (
                <div className="location-card" key={location.id}>
                  <div className="location-icon">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M21 10C21 17 12 23 12 23C12 23 3 17 3 10C3 7.61305 3.94821 5.32387 5.63604 3.63604C7.32387 1.94821 9.61305 1 12 1C14.3869 1 16.6761 1.94821 18.364 3.63604C20.0518 5.32387 21 7.61305 21 10Z" stroke="#0066cc" strokeWidth="2" fill="none"/>
                      <circle cx="12" cy="10" r="3" stroke="#0066cc" strokeWidth="2" fill="none"/>
                    </svg>
                  </div>
                  <h3>{location.area}</h3>
